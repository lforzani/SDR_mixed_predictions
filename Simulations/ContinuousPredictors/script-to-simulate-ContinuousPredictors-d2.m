clear all;
%Simulation for continuous predictor with d=2 
n = 2000;
rng(1000);
p=20; 
r = 5;
...
fycent1=get_fyZ(YY1);
[XX1] = GenDataContinuas(fycent1,Delta,A);
...
csvwrite('Continuous-d2-estimator.csv',Roptimalauto_2);
csvwrite('Continuous-d2-proyection.csv',PDoptimalauto_2);
          
csvwrite('Continuous-d2-estimator_PCA.csv',RD_PCA_2);
csvwrite('Continuous-d2-proyection_PCA.csv',PD_PCA_2);
