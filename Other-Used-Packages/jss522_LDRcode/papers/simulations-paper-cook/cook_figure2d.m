...
plot(sigg0,squeeze(angmean(1,:)),'-',sigg0,squeeze(angmean(2,:)),'-',sigg0 ,squeeze(angmean(3,:)),'-',sigg0 ,squeeze(angmean(4,:)),'-')
% labels
legend('SIR','OLS','EPFC','eigEPFC');
