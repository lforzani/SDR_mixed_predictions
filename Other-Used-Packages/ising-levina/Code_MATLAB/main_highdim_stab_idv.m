...
%     name = sprintf('Simulations/data_highdimIdv_q%d_p%d_n%d_val%d_reps%d_round%d.mat', q, p, n, val,k,r)
...
load(name);
        ...
        %% Save the files
		name = sprintf('Simulations/Results_HighdimIdvStab_q%d_p%d_n%d_val%d.mat', q, p, n, val);
